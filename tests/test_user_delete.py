...
class TestUserDelete(BaseCase):
    @allure.description("This case tries to delete user2. User 2 cannot be deleted.")
    ...
    @allure.description("This case is for success delete user")
    def test_user_delete_success(self):
        ...
        with allure.step("Check, that user was successfully deleted"):
    ...
    @allure.severity(allure.severity_level.MINOR)
    @allure.description("This case checks, that user cannot be deleted by another user")
